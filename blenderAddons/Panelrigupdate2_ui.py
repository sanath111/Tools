...
bpy.types.Armature.HidewingsRig = BoolProperty(name="HidewingsRig", description="wings", default=False, update=prop_update)
bpy.types.Armature.HidefakewingRig = BoolProperty(name="HidefakewingRig", description="fakewing", default=False, update=prop_update)
...
class wings(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = col.split()
        row.prop(context.active_object.data, "HidewingsRig", text="wings Rig", slider=False)
        row = row.split()
        row.prop(context.active_object.data, '["HidewingsMesh"]', text="wings Mesh", slider=False)
        row = col.split()
        row.prop(context.active_object.data, "HidefakewingRig", text="fakewings Rig", slider=False)
        row = row.split()
        row.prop(context.active_object.data, '["HidefakewingsMesh"]', text="fakewings Mesh", slider=False)         
        col.prop(context.active_object.data, '["HidehandMesh"]', text="Hand Mesh", slider=False)
